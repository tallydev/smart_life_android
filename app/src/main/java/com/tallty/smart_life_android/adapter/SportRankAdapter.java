...
public class SportRankAdapter extends RecyclerView.Adapter<SportRankAdapter.RankViewHolder> {
    ...
    public SportRankAdapter( Context context, ArrayList<SportRankItem> sportRankItems) {
    ...
    public RankViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(context).inflate(R.layout.item_step_rank, parent, false);
