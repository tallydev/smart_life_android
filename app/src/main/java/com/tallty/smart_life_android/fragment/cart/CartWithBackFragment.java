...
/**
 * Created by kang on 2017/2/11.
 * 带有返回功能的购物车页面
 */

public class CartWithBackFragment extends BaseBackFragment implements
    ...
    public static CartWithBackFragment newInstance() {
        Bundle args = new Bundle();
        CartWithBackFragment fragment = new CartWithBackFragment();
